...
RANDOM_SEED = 42
ROW_COUNT = 2400
OUTPUT_DIR = os.path.join("outputs", "sunspot_electronic_online_shop", "data_quality")
...
def main():
    ...
    raw_path = os.path.join(OUTPUT_DIR, "sunspot_electronic_online_shop_raw.csv")
    cleaned_path = os.path.join(OUTPUT_DIR, "sunspot_electronic_online_shop_cleaned.csv")
