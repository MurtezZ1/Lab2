...
const sampleProducts = [
  {
    id: 1,
    name: "Lenovo ThinkPad L15 Gen 2",
    manufacturer: "Lenovo",
    ...
    weight: "1.98 kg",
    dimensions: "36.6 x 25.0 x 2.1 cm",
    keyboard: "Backlit keyboard",
    ports: "2x USB-C, 2x USB-A, HDMI 2.0, Ethernet, microSD, 3.5mm audio",
    connectivity: "Wi-Fi 6, Bluetooth 5.1",
    camera: "720p HD webcam with privacy shutter",
    additional_features: "ThinkShield security, fingerprint reader, TPM 2.0, MIL-STD tested chassis",
    image: "https://images.unsplash.com/photo-1588872657578-7efd1f1555ed?auto=format&fit=crop&w=900&q=80",
    description: "Business-class Lenovo ThinkPad with durable chassis, enterprise security, and modern Intel performance.",
  },
  {
    id: 2,
    ...
    ram_size: "16GB LPDDR4x",
    storage: "512GB NVMe SSD",
    display: "13.3-inch Full HD IPS touch",
    os: "Windows 11 Home",
    battery: "Up to 13 hours",
    weight: "1.27 kg",
    dimensions: "30.6 x 19.5 x 1.69 cm",
    keyboard: "Backlit keyboard with fingerprint reader",
    ports: "2x Thunderbolt 3, USB-A, microSD, 3.5mm audio",
    connectivity: "Wi-Fi 6, Bluetooth 5.0",
    camera: "720p IR webcam with privacy switch",
    additional_features: "Convertible 2-in-1 design, aluminum body, Windows Hello, Bang & Olufsen speakers",
    image: "https://images.unsplash.com/photo-1484788984921-03950022c9ef?auto=format&fit=crop&w=900&q=80",
    description: "Premium convertible HP ultrabook with touch display, strong portability, and 2-in-1 flexibility.",
  },
  {
    id: 3,
    name: "Dell Inspiron 14 5406 2-in-1",
    manufacturer: "Dell",
    model: "Inspiron 14 5406 2-in-1",
    type: "laptop",
    year: 2021,
    price: 699.99,
    ...
    ram_size: "8GB DDR4",
    storage: "512GB NVMe SSD",
    display: "14-inch Full HD touch display",
    os: "Windows 11 Home",
    battery: "Up to 10 hours",
    weight: "1.62 kg",
    ...
    additional_features: "360-degree hinge, fingerprint reader, active pen support, aluminum palm rest",
    image: "https://images.unsplash.com/photo-1496181133206-80ce9b88a853?auto=format&fit=crop&w=900&q=80",
    description: "Convertible Dell Inspiron laptop with touchscreen, 11th Gen Intel performance, and everyday productivity features.",
  },
  {
    id: 5,
  ...
  },
  {
    ...
    display: "55-inch 4K OLED evo panel",
    os: "webOS 23",
    battery: "AC power",
...
const extraTechnologyProducts = technologyProductTemplates.flatMap((group) =>
  group.products.map((product) => {
    ...
    const hasBrandInName = String(name).toLowerCase().startsWith(group.manufacturer.toLowerCase());
    ...
    return {
      ...
      additional_features,
      image,
      description: `${hasBrandInName ? name : `${group.manufacturer} ${name}`} with real-world technology specifications, current-generation features, and realistic retail pricing.`,
    };
  }),
);
